...
#
html_theme_options = {
    'source_edit_link': 'https://github.com/canonical/real-time-ubuntu-docs',
}
...
llms_txt_description = textwrap.dedent(
    """\
    This is the documentation for Real-time Ubuntu, an Ubuntu version using the
    real-time kernel that is more preemptive than mainline, delivering lower
